  ...
  class FileLogger
    ...
    def initialize(log_file)
      ...
      begin
        ...
        File.new(@log_file, "w")
      # Rescue Errno::EACCES exception that occurs when file can't be created due to insufficient permissions
      rescue Errno::EACCES
    ...
    def write_to_log(message)
      ...
      # This {} syntax in Ruby allows a do...end block to be written on one line
...
puts "file writeable: #{file_logger.file_writable}"
